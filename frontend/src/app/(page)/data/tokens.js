      ...
      {hideTokenizer && (
        <div className="flex flex-col gap-3 my-5">
          <div>
            ...
            {/* badge kumpulan kata */}
            <div className="my-2 border dark:border-2 border-gray-400 dark:border-gray-700 rounded-md p-3 flex flex-col items-center">
              ...
              <form className="flex flex-col sm:flex-row gap-2 w-full sm:w-1/2 mt-2">
                <input
                  type="text"
                  name="new_subjek"
          ...
          <div>
            <div className="flex flex-col sm:flex-row items-center">
              <p className="text-xl font-bold w-full sm:w-auto">PREDIKAT | </p>
              <p className="text-sm ml-0 sm:ml-2">
